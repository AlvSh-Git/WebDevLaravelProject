<nav class="navbar navbar-expand-lg navbar-dark py-3 px-md-4 shadow-sm" style="background: linear-gradient(135deg,#00398e,#3578db);">
            ...
            <div class="d-flex text-white align-items-center">
                ...
                @else
                    <div class="position-relative ms-2">
                        <button class="btn btn-light btn-sm px-4 fw-bold rounded-pill text-primary d-flex align-items-center shadow-sm hover-shadow" type="button" id="customUserDropdown">
